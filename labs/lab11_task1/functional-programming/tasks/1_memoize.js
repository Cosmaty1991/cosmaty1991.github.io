...
/*
create a function that will wrap any other function to increase its performance by caching previously computed results
*/
...
function memoizeWrapper(fn) {
  return function(args) {
    ...
    return fn.memo[args] ? fn.memo[args] : fn.memo[args] = fn(args);
  };
}
// -------------
